...
async def create_tables():
    ...
    try:
        ...
        await conn.execute("""
            INSERT INTO team_members (id, name, subject, bio, "order", is_active)
            VALUES 
                ('team-1', 'Имам Ахмад', 'Теология и фикх', 'Специалист по исламской теологии и фикху с 15-летним опытом', 1, true),
                ('team-2', 'Устаз Мухаммад', 'Коран и таджвид', 'Эксперт по чтению Корана и правилам таджвида', 2, true),
                ('team-3', 'Шейх Али', 'Исламская история', 'Историк, специализирующийся на исламской истории и культуре', 3, true)
